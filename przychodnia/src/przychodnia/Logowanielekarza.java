 ...
 * @author Bartek
 */
public class Logowanielekarza extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        //nrP Label 
        Label nrPLabel = new Label("login:");
        ...
        button.setOnAction(e -> {
            ...
            try {
                pst = connect_baza.getConnection().prepareStatement("SELECT * FROM lekarze WHERE login=? and haslo=?");
